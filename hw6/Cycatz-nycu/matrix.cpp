...
py::array_t<double> Matrix::ndarray() {
  return py::array_t<double>(
                             py::buffer_info(
                                             this->m_elems, sizeof(double),
                                             py::format_descriptor<double>::format(),
                                             2,
                                             std::vector<size_t> {this->nrow(), this->ncol()},
                                             std::vector<size_t> {this->ncol() * sizeof(double), sizeof(double)}),
                             py::cast(this));                                            
}

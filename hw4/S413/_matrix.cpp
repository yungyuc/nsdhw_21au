...
public:
	...
	//if (nelement) { m_buffer.reserve(nelement); }
        //else { }
        m_nrow = nrow;
        m_ncol = ncol;
    }
...
std::size_t bytes() { return myAlloc.bytes(); }
std::size_t allocated() { return myAlloc.allocated(); }
std::size_t deallocated() { return myAlloc.deallocated(); }

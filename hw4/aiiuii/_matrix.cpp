...
public:
    Matrix(size_t nrow, size_t ncol)
        : m_nrow(nrow), m_ncol(ncol), m_buffer(custom_alloc)
    {
    ...
    double* raw() { return m_buffer.data(); }
    const double* raw() const{ return m_buffer.data(); }
...
size_t bytes() { return custom_alloc.counter.bytes(); }
size_t allocated() { return custom_alloc.counter.allocated(); }
size_t deallocated() { return custom_alloc.counter.deallocated(); }

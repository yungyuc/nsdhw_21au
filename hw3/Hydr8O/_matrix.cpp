...
PYBIND11_MODULE(_matrix, m) {
    ...
    py::class_<Matrix>(m, "Matrix")
        ...
        // .def("assign", static_cast<Matrix & (Matrix::*)(std::vector<double> const &)>(&Matrix::operator=))
        .def(py::self == py::self)
        .def(py::self != py::self)
...
//     Matrix mat1(1 * 1000, 1 * 1000);
//     initialize(mat1);
//     Matrix mat2 = mat1;
//     Matrix resultMKL = multiply_mkl(mat1, mat2);
//     Matrix resultNaive = multiply_naive(mat1, mat2);
//     Matrix resultTile = multiple_tile(mat1, mat2);
//     std::cout << resultMKL.elapsed() << std::endl;
//     std::cout << resultNaive.elapsed() << std::endl;
//     std::cout << resultTile.elapsed() << std::endl;
//     std::cout << "Results are: " << (resultMKL == resultNaive && resultNaive == resultTile) << std::endl;
